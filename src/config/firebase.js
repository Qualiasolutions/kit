...
const firebaseConfig = {
  apiKey: "AIzaSyCKP0oyoSR3y_FZb3rxvWv4HiNVekh1yyg",
  authDomain: "omum-99fd4.firebaseapp.com",
  projectId: "omum-99fd4",
  storageBucket: "omum-99fd4.firebasestorage.app",
  messagingSenderId: "988964522579",
  appId: "1:988964522579:web:bc0a663e25cf34836f94a6",
  measurementId: "G-1JJS1YM01Y"
};
  ...
  try {
    ...
    if (!serviceAccount && process.env.FIREBASE_PROJECT_ID) {
      ...
      serviceAccount = {
        ...
        project_id: process.env.FIREBASE_PROJECT_ID || 'omum-99fd4',
...
module.exports = { admin, firebase, auth, db, GoogleAuthProvider, firebaseConfig }; 